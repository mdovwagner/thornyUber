...
function City() {
  ...
  return /*#__PURE__*/React.createElement("symbol", {
    ...
    clipPath: houseClip,
    style: {
      display: "var(--house-0-display)",
      fill: "var(--house-0-color"
    }
  }), /*#__PURE__*/React.createElement("circle", {
    cx: cityPosition[15]['x'],
    cy: cityPosition[15]['y'],
    ...
    clipPath: houseClip,
    style: {
      display: "var(--house-1-display)",
      fill: "var(--house-1-color"
    }
  }), /*#__PURE__*/React.createElement("circle", {
    cx: cityPosition[20]['x'],
    cy: cityPosition[20]['y'],
    ...
    clipPath: houseClip,
    style: {
      display: "var(--house-2-display)",
      fill: "var(--house-2-color"
    }
  }), /*#__PURE__*/React.createElement("circle", {
    cx: cityPosition[3]['x'],
    cy: cityPosition[3]['y'],
    ...
    clipPath: houseClip,
    style: {
      display: "var(--house-3-display)",
      fill: "var(--house-3-color"
    }
  }));
}

const renderDefs = () => /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement(City, null));

const EdgeTypes = {
  edge: {
    shapeId: "#edge",
    shape: /*#__PURE__*/React.createElement("symbol", {
      viewBox: "0 0 50 50",
      id: "edge",
      key: "0"
    }, /*#__PURE__*/React.createElement("circle", {
...
export class ThornyUbersBoard extends React.Component {
  constructor(props) {
    super(props);
    this.renderNode = this.renderNode.bind(this); // this.renderBackground = this.renderBackground.bind(this)
  ...
  renderNode(nodeRef, data, index, selected, hovered) {
    ...
    let style = {
      '--region-color': data.region
    };

    if (stage === "place") {
      style = {
        '--region-color': this.props.tableau.includes(data.id) ? data.region : 'white'
      };
    }
    ...
    return /*#__PURE__*/React.createElement("use", {
      x: "-50",
      y: "-50",
      xlinkHref: "#city" // className={'node' + (usePointer ? ' city-selectable' : '')}
      ,
      style: style,
      cursor: "pointer"
    });
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", {
      ...
      renderDefs: renderDefs // renderBackground={this.renderBackground}
      ,
      initialBBox: {
        x: 0,
        y: 0,
      ...
      onSelectNode: node => {
        if (node) {
          this.props.selectCity(node.id);
        }
      },
      ref: this.graphView // Not needed
      ,
      selected: {},
      nodeSubtypes: {} // onUpdateNode={doNothing}

...
export default class Bonuses extends React.Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement(Card, {
      class: "section"
    }, /*#__PURE__*/React.createElement(Typography, null, "Bonuses"), Object.keys(this.props.bonuses).map(bonus => /*#__PURE__*/React.createElement(BonusChip, {
      key: bonus,
      bonus: bonus,
      point: this.props.bonuses[bonus][0]
    })));
  }
